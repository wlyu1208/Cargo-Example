...
@Repository
class CarBrandRepositoryImpl(private val jdbcTemplate: NamedParameterJdbcTemplate) : CarBrandRepository {
    override fun findById(id: Int): CarBrand? = jdbcTemplate.query(
